...
Prism.languages.clike = {
  ...
  keyword:
    /\b(if|else|async|await|while|do|for|return|in|instanceof|function|new|try|throw|catch|finally|null|break|continue)\b/,
...
(function () {
  ...
  Prism.hooks.add('before-highlight', function (env) {
    ...
    if (
      sib &&
      /\s*\bprism-show-language\b\s*/.test(sib.className) &&
      sib.firstChild &&
